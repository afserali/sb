...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div class="boxField"><div class="col-md-10 col-sm-10">'
			...
			+'</div></div>'
			+'</div>'
             +'<div class="col-md-2 col-sm-2 addCol"><a href="#" class="remove_field"><i class="fa fa-minus-circle" aria-hidden="true"></i></a>'
			+'<span class="addTotCol"><span>Total : </span><span>2 Boxes, 0 CBM</span></span>'
...
$(document).ready(function() {
    ...
    $(fcladd_button).click(function(e){ //on add input button click
        ...
        if(x < fclmax_fields){ //max input box allowed
            x++; //text box increment
            $(fclwrapper).append('<div class="fclboxField"><div class="col-md-12 col-sm-12">'
			+'<div class="col-md-2 col-sm-2"><div class="input-group">'
			...
			+'</div></div>'
			+'<div class="col-md-1 col-sm-1 addCol"><a href="#" class="fclremove_field"><i class="fa fa-minus-circle" aria-hidden="true"></i></a></div>'
			+'</div></div>');
             //add input box
        }
    });
    
    $(fclwrapper).on("click",".fclremove_field", function(e){ //user click on remove text
        e.preventDefault(); $(this).parent().parent().parent('.fclboxField').remove(); x--;
    })
});