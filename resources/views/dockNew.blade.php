      	...
      	<div class="row">
					<div class="container">
						<div class="page-title">
							<h1 class="">ICD</h1>
							<span class="breadcrumbs"><a href="../index">Home</a>&nbsp; /  &nbsp; ICD</span>
						</div>
					</div>
        ...
        <div class="container ">
			<div class="row ">
				...
				<div class="col-md-9  table-cell full-width">
					<p>Inland Container Depots, otherwise known as ICDs, are dry ports equipped for handling and temporary storage of containerized cargo as well as empties. This means that hinterland customers can receive port services more conveniently closer to their premises. The depots are directly linked to the container terminal in nearby ports by rail or road.</p>
					<p>In addition to their role in cargo transshipment, dry ports may also include facilities for storage and consolidation of goods, maintenance for road or rail cargo carriers and customs clearance services. The location of these facilities at a dry port relieves competition for storage and customs space at the seaport itself.</p>
					<p>A dry inland port can speed the flow of cargo between ships and major land transportation networks, creating a more central distribution point. Inland ports can improve the movement of imports and exports, moving the time-consuming sorting and processing of containers inland, away from congested seaports.</p>
					<p>Receiving, processing through customs, inspecting, sorting, and consolidating containers going to the same overseas port is also done at ICD. Container transfer at the seaport can be sped up and container handling space can be reduced by transferring functions to an inland site away from the port and coast.</p>
				</div>
			</div>
        </div>
	</div>
