      	...
      	<div class="row">
					<div class="container">
						<div class="page-title">
							<h1 class="">All Rights Reserved</h1>
							<span class="breadcrumbs"><a href="../index">Home</a>&nbsp; /  &nbsp; All Rights Reserved</span>
						</div>
					</div>
        ...
        <div class="container ">
			<div class="row ">
				...
				<div class="col-md-9  table-cell full-width">
					<p>Materials available in this Web sites are protected by copyright law and are operated by Shipping Bazaar Pvt. Ltd. or its affiliated companies ("shippingbazaar.com"). Copyright © 2015 Shipping Bazaar Pvt. ltd.  All rights reserved.</p>
					<p>No part of the materials including graphics or logos, available in this Web site may be copied, photocopied, reproduced, translated or reduced to any electronic medium or machine-readable form, in whole or in part, without specific permission from us.  Distribution for commercial purposes is prohibited.</p>
					<p>For more information, please read our Terms and Conditions</p>
				</div>
			</div>
        </div>
	</div>
