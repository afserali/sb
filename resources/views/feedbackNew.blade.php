      	...
      	<div class="row">
					<div class="container">
						<div class="page-title">
							...
							<span class="breadcrumbs"><a href="../index">Home</a>&nbsp; /  &nbsp; Feedback</span>
						</div>
					</div>
        ...
        <div class="container ">
			...
			<form id="feedback-form">
				...
				<div class="col-xs-12 col-md-12">
					<p class="feedback-satisfied-para">How satisfied were you with:</p>
					<div class="title-line-bg"></div>
					<table class="feedback-table">
						<thead class="feedback-head-bg">
							<tr>
								<td></td>
								<td><img src="../images/feedback_smiley/1.png"/><br/>Very Satisfied</td>
								<td><img src="../images/feedback_smiley/2.png"/><br/>Satisfied</td>
								<td><img src="../images/feedback_smiley/3.png"/><br/>Neutral</td>
								<td><img src="../images/feedback_smiley/4.png"/><br/>Unsatisfied</td>
								<td><img src="../images/feedback_smiley/5.png"/><br/>Very Unsatisfied</td>
							</tr>
						</thead>
						<tbody>
							<tr class="separate-td-bg">
								<td class="radio-label">Rate Search</td>
								<td><input type="radio" name="RateSearch" value="Very Satisfied" /></td>
								<td><input type="radio" name="RateSearch" value="Satisfied" /></td>
								<td><input type="radio" name="RateSearch" value="Neutral" /></td>
								<td><input type="radio" name="RateSearch" value="Unsatisfied" /></td>
								<td><input type="radio" name="RateSearch" value="Very Unsatisfied" /></td>
							</tr>
							<tr>
								<td class="error-td"><label for="RateSearch" class="error">Please Select One</label></td>
							</tr>
							<tr class="separate-td-bg2">
								<td class="radio-label">Flight Schedule</td>
								<td><input type="radio" name="FlightSchedule" value="Very Satisfied" /></td>
								<td><input type="radio" name="FlightSchedule" value="Satisfied" /></td>
								<td><input type="radio" name="FlightSchedule" value="Neutral" /></td>
								<td><input type="radio" name="FlightSchedule" value="Unsatisfied" /></td>
								<td><input type="radio" name="FlightSchedule" value="Very Unsatisfied" /></td>
							</tr>
							<tr>
								<td class="error-td"><label for="FlightSchedule" class="error">Please Select One</label></td>
							</tr>
							<tr class="separate-td-bg">
								<td class="radio-label">Informations</td>
								<td><input type="radio" name="Informations" value="Very Satisfied" /></td>
								<td><input type="radio" name="Informations" value="Satisfied" /></td>
								<td><input type="radio" name="Informations" value="Neutral" /></td>
								<td><input type="radio" name="Informations" value="Unsatisfied" /></td>
								<td><input type="radio" name="Informations" value="Very Unsatisfied" /></td>
							</tr>
							<tr>
								<td class="error-td"><label for="Informations" class="error">Please Select One</label></td>
							</tr>
							<tr class="separate-td-bg2">
								<td class="radio-label">Navigation</td>
								<td><input type="radio" name="Navigation" value="Very Satisfied" /></td>
								<td><input type="radio" name="Navigation" value="Satisfied" /></td>
								<td><input type="radio" name="Navigation" value="Neutral" /></td>
								<td><input type="radio" name="Navigation" value="Unsatisfied" /></td>
								<td><input type="radio" name="Navigation"value="Very Unsatisfied" /></td>
							</tr>
							<tr>
								<td class="error-td"><label for="Navigation" class="error">Please
										Select One</label></td>
							</tr>
							<tr class="separate-td-bg">
								<td class="radio-label">Look and Feel</td>
								<td><input type="radio" name="LookandFeel" value="Very Satisfied" /></td>
								<td><input type="radio" name="LookandFeel" value="Satisfied" /></td>
								<td><input type="radio" name="LookandFeel" value="Neutral" /></td>
								<td><input type="radio" name="LookandFeel" value="Unsatisfied" /></td>
								<td><input type="radio" name="LookandFeel" value="Very Unsatisfied" /></td>
							</tr>
							<tr>
								<td class="error-td"><label for="LookandFeel" class="error">Please
										Select One</label></td>
							</tr>
						</tbody>
					</table>
				...
				<div class="col-xs-12 col-md-12">
					<p class="feedback-area-content">Feel free to add any other
						comments or suggestions:</p>
					<div class="title-line-bg"></div>
					<textarea rows="4" name="comments" placeholder="Write a Comment..." style="width:100%; padding:10px;"></textarea>

					<p class="feedback-area-content">Feel free to add any other
						attachment:</p>
					<div class="title-line-bg"></div>
					<input type="file" name="attachement" id="feedbackfile">

					<p class="feedback-intro-para">* The information given within
						the Feedback Form will be used for service improvement only and
						are strictly confidential.</p>
					<div class="col-md-12">
					<div class="col-md-3">
					<input type="button" value="Submit" id="feedbackform-submit-btn" />
					</div>
					<div class="col-md-3"><input type="button" value="Clear" id="feedbackform-clear-btn" /></div>
					</div>
				</div>
