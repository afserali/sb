      	...
      	<div class="row">
					<div class="container">
						<div class="page-title">
							<h1 class="">Advertisement</h1>
							<span class="breadcrumbs"><a href="../index">Home</a>&nbsp; /  &nbsp; Advertisement</span>
						</div>
					</div>
        ...
        <div class="container ">
			<div class="row ">
				...
				<div class="col-md-9  table-cell full-width">
					<p >Thank you for choosing us for advertisements</p>
					<p>We assure you that we will do everything we can for your advertisements to really deliver.</p>
					<p>With Shipping Bazaar, you can be sure that your advertisements to work for you, since we want to to give you the best!</p>
					<p>Again , thank you. We hope we can give you the same satisfaction as what our loyal clients have been experiencing from us. We look forward to meeting you and to more years of continued business.</p>
					<p class="sub-header">Tariff applicable on half
					yearly basis: Other sizes &amp; animated banners option are available.
					Please contact us for details</p>
					<table class="advertisement-table">
					<tr>
						<th rowspan="2">Home Page</th>
						<td>Top Right Side</td>
						<td>US $ 1200</td>
					</tr>
					<tr>
						<td>Bottom Side Banners</td>
						<td>US $ 1000</td>
					</tr>

					<tr>
						<th>Search &amp; Report Page</th>
						<td>Bottom Side Banners (15 seconds)</td>
						<td>US $ 1200</td>
					</tr>
					...
					<tr>
						<th rowspan="2">Other Page</th>
						<td>Top Right</td>
						<td>US $ 1000</td>
					</tr>
					<tr>
						<td>Bottom Side Banner (15 seconds)</td>
						<td>US $ 900</td>
					</tr>
				</table>
				<p class="sub-header">Advertising agency commission: 20%</p>
				<p class="sub-header">Material required:</p>
				<p>Company logo: jpg, png, gif, crd or hard copy</p>
				<p class="sub-header">Terms and conditions</p>
					<ul class="ul_align">
					<li>The publisher reserves the right to reject or discontinue
						any web advertising or any part thereof.</li>
					<li>Payment in advance.</li>
					<li>Validity of each ad is 6 months only.</li>
					<li>Renewal of contract is Automatic upon expiry, unless
						termination of contract has been received in advance.</li>
					<li>Advertiser indemnifies the publisher from any and all
						liability for content of advertisement and company website.</li>
					<li><b>Cancellations:</b> No cancellations are accepted during
						the contract period. Full advertisement cost will apply if
						advertisement is cancelled after production of logo entry in the
						website.</li>
					<li>For more info please write to us at <b>customer.service@shippingbazaar.com</b></li>
				</ul>
				</div>
			</div>
        </div>
