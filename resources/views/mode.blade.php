      	...
      	<div class="row">
					<div class="container">
						<div class="page-title">
							<h1 class="">Mode</h1>
							<span class="breadcrumbs"><a href="../index">Home</a>&nbsp; /  &nbsp; Mode</span>
						</div>
					</div>
        ...
        <div class="container ">
			<div class="row ">
				...
				<div class="col-md-12  table-cell full-width">
					<h5 class="mode-title">Customers in INDIA</h5>
					<p>Payment can be done through NEFT / Cheque / Demand Draft / Credit Card / Debit Card or Net Banking to our Axis Bank A/c.</p>
					<h5 class="mode-title">Overseas Customers</h5>
					<p>Payment can be done through PayPal / Credit Card / Debit Card or Net Banking to our Axis Bank A/c.</p>
				</div>
			</div>
        </div>
	</div>
