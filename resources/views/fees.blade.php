      	...
      	<div class="row">
					<div class="container">
						<div class="page-title">
							<h1 class="">Fees</h1>
							<span class="breadcrumbs"><a href="../index">Home</a>&nbsp; /  &nbsp; Fees</span>
						</div>
					</div>
        ...
        <div class="container ">
			<div class="row ">
				<div class="col-md-3 subpg-img">
					...
					<div class="fess-cnt">
					<p>Shipping Bazzar offers paid services for database information. Following are our tariff for database license:</p>
					<p>1st User in Same Office:</p>
					<p>1 Countryto Another Country all ports:   USD 200</p>
					<p>Additional User in Same office:</p>
					<p>1 Country to Another Country all ports:   USD 110 per user</p>
					</div>
				</div>
			</div>
        </div>
