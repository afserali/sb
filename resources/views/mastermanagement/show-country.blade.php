                                ...
                                <tbody>
                                    ...
                                    @foreach($codes as $code)
                                        <tr>
                                            ...
                                            <td>
                                            <a href="editcountry/{{$code->id}}" class="btn btn-info" >Edit</a>
                                            </td>
                                            <td>
                                             {!! Form::open(array('url' => 'showcountry/' . $code->id, 'class' => '', 'data-toggle' => 'tooltip', 'title' => 'Delete')) !!}
                                                    {!! Form::hidden('_method', 'DELETE') !!}
                                                    {!! Form::button('<i class="fa fa-trash-o fa-fw" aria-hidden="true"></i> <span class="hidden-xs hidden-sm">Delete</span><span class="hidden-xs hidden-sm hidden-md"> Section</span>', array('class' => 'btn btn-danger btn-sm','type' => 'button', 'style' =>'width: 100%;' ,'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete Section', 'data-message' => 'Are you sure you want to delete this Country ?')) !!}
                                                {!! Form::close() !!}
                                            </td>
