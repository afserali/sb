      	...
      	<div class="row">
					<div class="container">
						<div class="page-title">
							<h1 class="">IMDG </h1>
							<span class="breadcrumbs"><a href="../index">Home</a>&nbsp; /  &nbsp; IMDG</span>
						</div>
					</div>
        ...
        <div class="container ">
			<div class="row ">
				...
				<div class="col-md-9  table-cell full-width">
					<p >The International Maritime Dangerous Goods (IMDG) Code was adopted in 1965 as per the SOLAS (Safety for Life at Sea) Convention of 1960. The IMDG Code was formed to prevent all types of pollutions at sea.</p>
					<p>A dangerous goods code has been created as per the recommendations of the United Nations’ panel of expert on transport of dangerous goods along with the IMO (International Maritime Organisation) to avoid complications while shipping. IMDG Code was started in the year 1961.</p>
					<p>There are nine categories in which the dangerous goods are classified. The same can be explained as follows:</p>
					<ul class="ul_align">
						<li>Classification I: is for explosives. The same classification has six sub-divisions like materials which pose high explosive risk, low explosive risk to name a few</li>
						<li>Classification II” is for gases. This category has three sub-categories that talk about gases that are highly inflammable, that are not inflammable and gases that neither inflammable nor toxic</li>
						<li>Classification III: is for liquids and has no sub-divisions</li>
						<li>Classification IV: is for solids. There are three sub-categories that deal with highly combustible solids, self-reactive solids and solids that when interact with water could emit toxic gases</li>
						<li>Classification V: is for substances that have the chances of oxidisation</li>
						<li>Classification VI: is for all kinds of substances that are toxic and that could prove to be infective</li>
						<li>Classification VII: is specifically for materials that are radioactive</li>
						<li>Classification VIII: is for materials that face the threat of corrosion and erosion</li>
					    <li>Classification IX: is for those substances that cannot be classified under any of the above heads but still are dangerous goods</li>
					</ul>
					<p>At present the reach of the IMDG Code extends to about 150 countries around the world with around 98% ships following the requirements of the code. This figure helps us to understand the effectiveness of the code with respect to shipping dangerous goods across the oceans and the marine life-forms that exist in them.</p>
					<p>Dangerous or Hazardous Goods should always be handled by a professional only who make sure the packing and documentation adhere to ICAO, IATA, and IMDG regulations. A List of the best IMDG Packers are presented in Shipping Bazaar.</p>
				</div>	
			</div>
        </div>
	</div>
