      	...
      	<div class="row">
					<div class="container">
						<div class="page-title">
							...
							<span class="breadcrumbs"><a href="../index">Home</a>&nbsp; /  &nbsp; About Us</span>
						</div>
					</div>
        ...
        <div class="container ">
			<div class="row ">
				...
				<div class="col-md-9  table-cell full-width">
					<p>ShippingBazaar.com is a first of its kind data aggregator which will provide information related to Ocean Freight Industry viz. Current Tariff Rates, Schedules, Tracking and many other services on this highly growing competitive industry.</p>
					<p>As you are aware that there is no common platform exists in this industry to get One Stop Solutions on requirements by the Exim Community. Therefore, we have inherited this idea to organise this multiple task into One Platform to simplify their requirements which will allow all the stake holders to get their work done faster, easier and smoother way without losing a moment.</p>
					<p>Keeping best commercial interests of all stake holders, we operates as a 100% neutral service provider who is working just as an aggregator. Since, we are a responsible and duty bound operator to keep the neutrality of business to facilitate the information through this platform. Our common platform will expedite the work to reach maximum numbers of users to get the greater benefits to the stake holders.</p>
					<p>We have included several features in our portal for the Carriers to market directly such as Rate feeding, Options to change any particular rate at any time with a new validity, Direct Announcements to Subscribers by email and SMS, Subscribers list for direct marketing, Schedules with feeder Operators information,Vessel information, Containeravailabilityetc.</p>
				</div>
			</div>
        </div>
	</div>
