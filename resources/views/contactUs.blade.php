      	...
      	<div class="row">
					<div class="container">
						<div class="page-title">
							...
							<span class="breadcrumbs"><a href="../index">Home</a>&nbsp; /  &nbsp; Contact Us</span>
						</div>
					</div>
        ...
        <div class="container ">
			<div class="row ">
				...
				<div class="col-md-9  table-cell full-width">
					...
					<p >Shipping Bazaar Pvt. Ltd.</p>
					<p>2A, 2nd Floor, 3/5 Palat Sankaran Street,</p>
					<p>Chennai 600 034, India</p>
					<p>Tel: +91 44 65550595</p>
					<p>Email: customer.service@shippingbazaar.com</p>
					</div>
				</div>
			</div>
        </div>
