 ...
 <ul class="nav navbar-nav">
      ...
      <li id="synonyms"><a href="{{ URL::to('/thesaurus') }}" >Synonyms</a></li>
        ...
        <li class="dropdown" id="explore">
         <a href="../explore/explore.blade.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" id="explore">Explore<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="#">Action</a></li>
            <li><a href="#">Another action</a></li>
            <li><a href="#">Something else here</a></li>
