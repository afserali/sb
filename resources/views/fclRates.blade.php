      	...
      	<div class="row">
					<div class="container">
						<div class="page-title">
							<h1 class="">FCL Rates</h1>
							<span class="breadcrumbs"><a href="../index">Home</a>&nbsp; /  &nbsp; FCL Rates</span>
						</div>
					</div>
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                       ...
                       <!--  <li>
                        ...
                        <li class="misgn_sb"><a class="msign_af" id="logindiv" href="#" style="border: none;">Login</a></li>
