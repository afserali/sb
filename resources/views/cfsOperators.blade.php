      	...
      	<div class="row">
					<div class="container">
						<div class="page-title">
							<h1 class="">CFS Operator</h1>
							<span class="breadcrumbs"><a href="../index">Home</a>&nbsp; /  &nbsp; CFS Operator</span>
						</div>
					</div>
        ...
        <div class="container ">
			<div class="row ">
				...
				<div class="col-md-9  table-cell full-width">
					...
					<p>CFS Operators is an essential part of the multimodal transport activity because they aggregate cargo and ensures safe transport and delivery to its end customers. They are well equipped with developed container yards, modern warehouses and modern equipment.CFS Operators facilitates LCL consolidation, Hazardous cargo handling, Reefer Monitoring and storing. Shipping Bazaar presents the leaders in this industry here.</p>
